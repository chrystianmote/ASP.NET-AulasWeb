...
<body>
    ...
    <div class="divBG">
        ...
        <div class="Campo">
            <p>
                <b>@nome ou E-mail<br />
                    <input id="txtNome" type="text" value="Login" class="Campos" />
                    <br />
                    Senha<br />
                    <input id="txtPassword" type="password" value="Senha" />
                    &nbsp<input id="btnIr" type="button" value="Entrar" class="botao" />
                    <br />
                    <input id="Checkbox1" type="checkbox" />
                </b><span style="font-family: Calibri;">Lembrar-me &nbsp <a href="#" class="Esqsenha">
                    -Esqueceu sua senha?</a></span>
                <br />
                <br />
                <br />
                ...
                <br />
                <input id="btnInscrever" type="button" value="Inscrever-se no Twitter" />
            </p>
        </div>
    <%--<div class="ptexto1">
        <p>
    ...
    <div>
        <ul class="Menu">
            ...
            <li><a href="#"><span style="color: #3586FF">© 2012 Twitter</span></a></li>
        </ul>
        <%--<p  class="pFim">
        </p>--%>
    </div>
