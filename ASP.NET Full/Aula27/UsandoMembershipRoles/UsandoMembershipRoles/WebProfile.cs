...
namespace UsandoMembershipRoles {
    ...
    public partial class WebProfile {
        ...
        public virtual string Cidade {
            get {
                return ((string)(this.GetPropertyValue("Cidade")));
            }
            set {
                this.SetPropertyValue("Cidade", value);
            }
        }
        
        public virtual string Endereco {
            get {
                return ((string)(this.GetPropertyValue("Endereco")));
            }
            set {
                this.SetPropertyValue("Endereco", value);
            }
        }
        
        public virtual string NomeCompleto {
            get {
                return ((string)(this.GetPropertyValue("NomeCompleto")));
            }
            set {
                this.SetPropertyValue("NomeCompleto", value);
            }
        }
