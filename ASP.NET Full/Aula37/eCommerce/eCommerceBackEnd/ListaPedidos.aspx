...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    <title>SGP Design e-Commerce :: Pedidos Realizados</title>
</asp:Content>
                ...
                <asp:GridView ID="gvLista" runat="server" AutoGenerateColumns="False" OnRowCommand="gvLista_RowCommand"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Status">
                            <ItemTemplate>
                                <asp:ImageButton ID="ImageButton1" ImageUrl="~/Images/DiminuirStatus.gif" runat="server" ToolTip="Diminuir status"
                                    CommandName="DiminuirStatus" CommandArgument='<%# Eval("IdPedido") %>' />
                                <asp:Label ID="lblStatus" runat="server" Text='<%# Bind("Status") %>'></asp:Label>
                                <asp:ImageButton ID="ImageButton2" ImageUrl="~/Images/AumentarStatus.gif" runat="server" ToolTip="Aumentar status"
