<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="CasasEstranhas.com.Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphConteudo" runat="server">
    ...
    <asp:ListView ID="lvCasas" runat="server" DataSourceID="sqldsCasasEmDestaque">
        <EmptyItemTemplate>
            <h2>Não há casas a serem exibidas.</h2>
        </EmptyItemTemplate>
        ...
        <ItemTemplate>
            ...
            <div class="alignright" style="width:128px;height:192px;">
                <img src='<%# "img/casas/" + Eval("id", "{0:0000}") + ".jpg" %>' 
            ...
            <p>
                <a href='<%# "EfetuarLance.aspx?casa=" + Eval("id")  %>' >
                    Quero dar um lance
                </a>
            </p>
        ...
        <AlternatingItemTemplate>
            ...
            <p>
                <a href='<%# "EfetuarLance.aspx?id=" + Eval("id")  %>' >
                    Quero dar um lance
                </a>
            </p>
    ...
    <asp:SqlDataSource ID="sqldsCasasEmDestaque" runat="server" 
        ...
        SelectCommand="SELECT TOP 5 [id], [nome], [descricao], [visitas], [data_finalizacao], [maior_lance], [executor_lance] FROM [Casa] ORDER BY [visitas] DESC">
    </asp:SqlDataSource>
    <asp:SqlDataSource ID="sqldsCasasPorCategoria" runat="server" 
        ConnectionString="<%$ ConnectionStrings:CasasEstranhasConnectionString %>" 
        SelectCommand="SELECT [id], [nome], [descricao], [visitas], [data_finalizacao], [maior_lance], [executor_lance] 
FROM [Casa] 
