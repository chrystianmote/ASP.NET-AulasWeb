<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true"
    CodeBehind="EfetuarLance.aspx.cs" Inherits="CasasEstranhas.com.EfetuarLance" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cphConteudo" runat="server">
    <asp:FormView ID="fvDetalhesCasa" runat="server" DataKeyNames="id" DataSourceID="sqldsDetalhesCasa">
        <ItemTemplate>
            <h3 class="text-left">
                <%# Eval("nome") %></h3>
            <h6 class="text-left">
                <%# "Categoria: " + Eval("categoria") %></h6>
            <div class="clear">
            </div>
            <div class="aligncenter">
                <img src='<%# "img/casas/" + 
                    Eval("id", "{0:0000}") + ".jpg" %>' alt="" class="bordered" style="width: 400px;" />
            </div>
            ...
            <p>
                ...
                <asp:HiddenField runat="server" ID="hdfMaiorLance" Value='<%# Eval("maior_lance").ToString() == "" ?
                        Eval("preco_minimo") : 
                        Eval("maior_lance") %>' />
            </p>
            <p>
    ...
    <asp:SqlDataSource ID="sqldsDetalhesCasa" runat="server" ConnectionString="<%$ ConnectionStrings:CasasEstranhasConnectionString %>"
    ...
    <asp:RequiredFieldValidator ID="rfvNome" runat="server" ErrorMessage="Preenchimento obrigatório."
        ControlToValidate="txtNome">
    </asp:RequiredFieldValidator>
    <br />
    <b>Seu lance:</b><br />
    <input id="txtLance" runat="server" alt="decimal" />
    <asp:RequiredFieldValidator ID="rfvLance" runat="server" ErrorMessage="Preenchimento obrigatório."
        ControlToValidate="txtLance" Display="Dynamic"></asp:RequiredFieldValidator>
    ...
    <br />
    <asp:LinkButton runat="server" ID="btnEfetuarLance" OnClick="btnEfetuarLance_Click">
