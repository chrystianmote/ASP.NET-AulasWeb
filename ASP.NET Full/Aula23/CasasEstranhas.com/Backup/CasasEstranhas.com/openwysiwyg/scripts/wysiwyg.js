...
var WYSIWYG = {
    ...
    */
    ...
    ToolbarList: {
        ...
        "bold": ['Bold', 'Negrito', 'bold.gif', 'bold_on.gif'],
        "italic": ['Italic', 'Italico', 'italics.gif', 'italics_on.gif'],
        "underline": ['Underline', 'Sublinhado', 'underline.gif', 'underline_on.gif'],
        "strikethrough": ['Strikethrough', 'Riscado', 'strikethrough.gif', 'strikethrough_on.gif'],
        "seperator": ['', '', 'seperator.gif', 'seperator.gif'],
        "subscript": ['Subscript', 'Subscrito', 'subscript.gif', 'subscript_on.gif'],
