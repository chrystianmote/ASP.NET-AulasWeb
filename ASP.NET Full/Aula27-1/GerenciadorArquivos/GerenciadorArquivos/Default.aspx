...
<body>
    ...
    <div>
        <h1>
            Gerenciador de Arquivos</h1>
        <asp:Button ID="btnAnterior" runat="server" OnClick="btnAnterior_Click" Text="Diretório Pai" />
        <br />
        <br />
        <asp:Label ID="lblDirAtual" runat="server" ForeColor="#DF0005"></asp:Label>
        <br />
        <br />
